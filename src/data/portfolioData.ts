...
export const PORTFOLIO_HERO = {
  ...
  stats: [
    { value: "+141%", label: "Max Funnel CVR Uplift", sub: "Bookify CRO Redesign" },
...
export const PROJECTS_DATA: ProjectItem[] = [
  {
    ...
    subtitle: "High-Conversion Art & Photo Books E-Commerce Platform",
    client: "Bookify Store / Collectibles",
    year: "2026",
    category: "ecommerce-cro",
    categoryLabel: "E-Commerce & Funnel CRO",
    imageSrc: "/projects/bookify/slide_01.jpg",
    slides: [
      "/projects/bookify/slide_01.jpg",
      "/projects/bookify/slide_02.jpg",
      "/projects/bookify/slide_03.jpg",
      "/projects/bookify/slide_04.jpg",
      "/projects/bookify/slide_05.jpg",
      "/projects/bookify/slide_06.jpg",
      "/projects/bookify/slide_07.jpg"
    ],
    summary: "Strategic UX/UI redesign and CRO overhaul for Bookify art book platform. Replaced generic e-commerce templates with curated visual hierarchy, double-spread previews, transparent specs, and 1-tap in-context modal purchasing.",
    challenge: "Generic catalog grids caused 68% cart abandonment, high bounce rates on high-ticket art editions (₴400–₴600), and buyer hesitation regarding physical binding and print fidelity.",
    solution: "Architected a 4-stage persuasion funnel (Curated Catalog, Double-Spread Interior Previews, Verified Collector Trust Badges, and Zero-Redirect Modal Checkout with Apple/Google Pay).",
    role: "Lead / Senior Product Designer (Funnel Optimization, Visual Direction, Design Tokens & CRO Architecture)",
    metrics: [
    ...
    tools: ["Figma (Variables & AutoLayout)", "Next.js / Tailwind CSS", "Apple / Google Pay Primitives", "Plus Jakarta Sans & Inter", "CRO Analytics"],
    deliverables: [
      "4-Stage Conversion Funnel UX Architecture",
      "High-Density Editorial Catalog & Detail Specs",
