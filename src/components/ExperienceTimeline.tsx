      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl space-y-3">
            ...
            <p className="text-sm sm:text-base text-[#adb3b7] leading-relaxed">
          ...
          {/* Interactive Switcher & Download Control Bar */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-white/[0.02] p-2 rounded-2xl border border-white/10 backdrop-blur-md">
            {/* View Mode Switcher */}
            <div className="relative flex items-center bg-black/40 p-1 rounded-xl border border-white/5">
              <button
                onClick={() => setViewMode("executive")}
                className={`relative px-3.5 py-1.5 rounded-lg text-xs font-mono font-medium transition-all duration-200 z-10 ${
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-mono text-zinc-200 hover:text-white bg-blue-600/15 hover:bg-blue-600/30 border border-blue-500/30 hover:border-blue-400 transition-all active:scale-95 disabled:opacity-50"
                title="Download ATS-compliant Word (.docx) document"
              >
                <FileText className="w-3.5 h-3.5 text-blue-400" />
                <span>{isDownloading ? "BUILDING..." : "CV .DOCX"}</span>
                <Download className="w-3 h-3 text-blue-400/80 ml-0.5" />
              </button>

              <Link
                href="/cv"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-mono text-zinc-200 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all active:scale-95"
